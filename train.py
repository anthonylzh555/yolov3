...
# Remove the pound sign to deactivate GPU
#----------------------------------------------------------
...
def train_main():
    # own_data path
    annotation_path = 'own_datapath.txt'
    
    # traing weight path, trained_weights_final.h5 is the one we need
    log_dir = 'logs/training_weight_001/'
    ...
    # Adjust the input size of the img
